...
exec_filters = [
	...
	#('opath', 'direct', [('SP', 1), ("PP", 1), ("Li", 1), ('BSDF', 1)], 'strict'),
	#('opath', 'direct', [('SP', 1), ("PP", 1), ("Li", 1), ('BSDF', 1)], 'loose'),
	#('opath', 'balance', [('SP', 1), ("PP", 1), ("Li", 1), ('BSDF', 1)], 'loose'),
	...
	#('opath', 'balance', [('spatial-Li', 1), ('NSS-Li', 1), ], 'loose'),
	#('opath', 'direct', [('spatial-Li', 1), ('NSS-Li', 1), ], 'loose'),
	#('opath', 'direct', [('spatial-Li', 1), ('NSS-Li', 1), ], 'strict'),
]
